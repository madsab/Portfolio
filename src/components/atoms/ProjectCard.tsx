    ...
    <div className="w-[30.8%]">
      <Reveal>
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center px-9 text-center translate-y-[75%] group-hover:translate-y-0 group-hover:justify-center transition-all">
